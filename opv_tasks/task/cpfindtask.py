...
""" cpfind Task, will find control points.

Usage:
    opv-task-cpfind <id-lot> [--db-rest=<str>] [--dir-manager=<str>] [--debug]
    opv-task-cpfind (-h | --help)
...
def main():
    ...
    task = CpfindTask(client_requestor=Client(arguments['--db-rest']), opv_directorymanager_client=dir_manager_client)
